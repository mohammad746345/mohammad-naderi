...
const SignUp2 = () => {
    ...
    const onSubmit = () => {
        axios({
          method: 'put',
          url: `${API_Register}`,
          data:{national_id:state["national_id"], username:state["username"], token:pinCode, type: state["type"]}
        }).then(resp => {
          ...
          <Col lg={12} sm={12} className="d-flex flex-row justify-content-between shadow-lg p-0" style={{ height:"667px" }}>
            ...
            <div className="col-12 d-flex justify-content-start">
              ...
              <Col lg={12} className="d-flex flex-column justify-content-between">
                <p className="col-12 d-flex justify-content-start" style={{ fontSize:"21px",fontWeight:"bold",color:"#094049",marginBottom:"20px" }}>احراز هویت</p>
